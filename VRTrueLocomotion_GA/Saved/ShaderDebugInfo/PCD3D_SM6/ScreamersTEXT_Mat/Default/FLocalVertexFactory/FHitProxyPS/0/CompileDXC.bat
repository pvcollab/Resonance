...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc HitProxyPixelShader.d3dasm /Fo HitProxyPixelShader.dxil HitProxyPixelShader.usf
:END
PAUSE
